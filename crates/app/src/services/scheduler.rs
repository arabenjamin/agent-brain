...
impl SchedulerService {
    ...
    async fn goal_to_steps(
        ...
        let mut steps = if g.starts_with("meta-learn:") || g.contains("hypothesize root cause") {
            ...
            let hypothesis_question = format!(
                "You are a meta-learning system running the Analyze→Hypothesize→Test→Integrate cycle.\n\n\
                 ...
                 2. HYPOTHESIZE: Form a specific, testable hypothesis about the root cause.\n\
                 3. TEST: Propose a concrete, observable test that would confirm or refute the hypothesis.\n\
                 4. INTEGRATE: What change to tooling, documentation, or procedure would prevent recurrence?\n\n\
                 Structure your response clearly with these four headings."
            );
            vec![
                ChainStep {
                    ...
                    context_profile: None,
                    ttl_secs: None,
                    description: Some("Meta-learn: gather failure evidence".to_string()),
                    ..Default::default()
                },
                ChainStep {
                    ...
                    context_profile: None,
                    ttl_secs: None,
                    description: Some("Meta-learn: form hypothesis and propose test".to_string()),
                    ..Default::default()
                },
                ChainStep {
                    tool_name: "store_note".to_string(),
                    ...
                    context_profile: None,
                    ttl_secs: None,
                    description: Some("Meta-learn: store hypothesis note for review".to_string()),
                    ..Default::default()
                },
                ChainStep {
                    ...
                    ttl_secs: None,
                    description: Some(
                        "Meta-learn: integrate findings into semantic memory".to_string(),
                    ),
                    ..Default::default()
                },
            ]
        ...
        self.maybe_append_evaluator(steps, task_id, chain_rubric.as_deref())
    }
